...
\begin{figure}
\includegraphics[width=6cm, keepaspectratio,]{res/img/hist1.png}
\includegraphics[width=6cm, keepaspectratio,]{res/img/lines.png}
\includegraphics[width=6cm, keepaspectratio,]{res/img/hist_diff.png}
\includegraphics[width=6cm, keepaspectratio,]{res/img/full.png}
\caption{
\emph{(Upper-left)} Histogram of the times to find the hotspots per guidance condition. 
\emph{(Upper-right)} Line plot showing the average time to find the hotspot ($\pm{ SE}$) per subject and per guidance condition. 
\emph{(Bottom-left)} Histogram of the differences (paired by hotspot) in time to find the hotspot.
\emph{(Bottom-right)} Time to find target hotspot location for each participant, colored by guidance mode.}
\label{fig:res}
\end{figure}
