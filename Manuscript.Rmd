...
output:
  word_document:
    reference_docx: res/templates/template.docx
    toc: no
  pdf_document:
    template: res/templates/template.tex
    toc: no
    keep_tex: yes
institutes:
- id: 1
...
knitr::include_graphics("res/img/fig1a.jpg")
knitr::include_graphics("res/img/fig1b.jpg")
```
